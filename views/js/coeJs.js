const app = new Vue({
    ...
    methods: {
        ...
        drawSatellite: function (sat, forward = false) {
            ...
            sat.mA -= this.timeStep !== this.oldTimeStep ? Math.sqrt(398600.4418 / sat.sma / sat.sma / sat.sma) * (this.timeStep-this.oldTimeStep) : 0;
        ...
        changeCommon: function (orbit) {
            ...
            switch (orbit) {
                case 'geo':
                    this.satellites[sat].sma = 42164.14010012396;
