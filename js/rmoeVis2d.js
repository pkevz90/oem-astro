let globalChartRef1, globalChartRef2, globalChartRef3, axisLimits = 20, axisCenter = 0;
...
function calculateTrajecories(){
	...
	let r = [[-app.ae/2*Math.cos(beta)+app.xd],[app.ae*Math.sin(beta)+app.yd],[app.zmax*Math.sin(m)]];
	let v = [[app.ae*n/2*Math.sin(beta)],[app.ae*n*Math.cos(beta)-1.5*app.xd*n],[app.zmax*n*Math.cos(m)]];
